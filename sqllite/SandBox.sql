...
-------------------------------------------------------------------------------------------------------------------------
  select a.*, outstanding.os, outstanding.[status], outstanding.cost, outstanding.realize, outstanding.accu_realize, outstanding.unrealize
  from transx as a 
  LEFT JOIN outstanding ON a.TxID = outstanding.TxID
  --WHERE a.Fund_Code = 'SCBTEQ'
